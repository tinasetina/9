...
cd
rm -rf /root/.bashrc
wget -O /root/.bashrc "https://raw.githubusercontent.com/tinasetina/9/master/.bashrc"
# install lolcat
...
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/surinvpn/benz/master/openvpn.tar"
cd /etc/openvpn/;tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "https://raw.githubusercontent.com/tinasetina/9/master/rc.local";chmod +x /etc/rc.local
#wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/tinasetina/9/master/iptables.up.rules"
...
# etc
wget -O /home/vps/public_html/client.ovpn "https://raw.githubusercontent.com/tinasetina/9/master/client.ovpn"
